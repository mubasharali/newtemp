...
function RefreshSearch() {
    ...
    self.isLoading(true);
    $.ajax({
        url: '/api/Vehicle/SearchBikeAds?brand=' + brand() + '&model=' + model() + '&tags=' + tags() + '&title=' + title() + '&minPrice=' + minPrice() + '&maxPrice=' + maxPrice() + '&city=' + searchingCity() + '&pp=' + searchingPP(),
        dataType: "json",
        contentType: "application/json",
        cache: false,
        type: 'POST',
